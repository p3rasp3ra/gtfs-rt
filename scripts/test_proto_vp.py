#!/usr/bin/env python3
"""
REST API Test Script for GTFS-RT Protobuf Endpoint
Tests the HTTP POST endpoint that accepts FeedEntity.
For MQTT testing, use mqtt_test_publisher.py instead.
